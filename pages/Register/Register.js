...
function Register() {
  ...
  const handelSubmit=(e)=>{
    e.preventDefault()
    dispatch(register({name,email,password}) , navigate("/Profile"))
                    ...
                    <div className="row mb-4 pb-2 pb-md-0 mb-md-5">
                      <div className="col-md-6">
                        <div className="form-outline">
                          <input type="text" id="form3Example1w" className="form-control" onChange={(e)=>setPassword(e.target.value)} value={password}/>
                          <label className="form-label" htmlFor="form3Example1w">Password</label>
                        </div>
                      </div>
                    </div>
                    <button type="submit" className="btn btn-success btn-lg mb-1" onClick={handelSubmit }>Submit</button>
                  </form>
                </div>
              </div>
            </div>
